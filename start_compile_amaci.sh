...
compile_and_ts_and_witness() {
  ...
  itime="$(date -u +%s)"
  circom external/a-maci-evm/circuits/prod/msg.circom --r1cs --wasm --sym -o $OUTPUT_DIR/r1cs
  circom external/a-maci-evm/circuits/prod/tally.circom --r1cs --wasm --sym -o $OUTPUT_DIR/r1cs
  circom external/a-maci-evm/circuits/prod/addKey.circom --r1cs --wasm --sym -o $OUTPUT_DIR/r1cs
  circom external/a-maci-evm/circuits/prod/deactivate.circom --r1cs --wasm --sym -o $OUTPUT_DIR/r1cs
  ftime="$(date -u +%s)"
  ...
  snarkjs g16s $OUTPUT_DIR/r1cs/addKey.r1cs ptau/powersOfTau28_hez_final_18.ptau $OUTPUT_DIR/zkey/addKey_0.zkey
  snarkjs g16s $OUTPUT_DIR/r1cs/deactivate.r1cs ptau/powersOfTau28_hez_final_18.ptau $OUTPUT_DIR/zkey/deactivate_0.zkey
